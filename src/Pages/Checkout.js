              ...
              <div className="d-flex mb-2 gap-10 align-items-center">
                <div className='w-75 d-flex gap-10'>
                  <div className='w-25 position-relative gb-dark'>
                    <span style={{top: "-20px", right: "-5px"}}className="badge bg-secondary text-white rounded-circle p-3 position-absolute p-2">1</span>
                    <img src="../images/watch.jpg" alt="watch" className="img-fluid"/>
                  </div>
                  <div>
                    <h5 className=" total-price">grgqs</h5>
                    <p className='total-price'>jdfjgj</p>
                  </div>
                </div>
                <div className='flex-grow-1'>
